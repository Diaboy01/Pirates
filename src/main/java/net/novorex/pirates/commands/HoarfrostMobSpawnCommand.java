...
public class HoarfrostMobSpawnCommand implements CommandExecutor {
    @Override
        ...
        if (sender.isOp()) {
            ...
            for(Entity e : player.getNearbyEntities(50, 50, 50)) {
                if (e instanceof Player && e.getType() == EntityType.PLAYER) {
                    ...
                    Bukkit.getScheduler().runTaskLater(Main.instance, () -> Bukkit.dispatchCommand(console, "minecraft:summon pirates_armoury:hoar_frost " + x + " " + y + " " + z), 20L * 10);
                }
            }
